...
from src.funcs import create_list_obj, sort_salary_from
...
def user_interaction():
    ...
    print("Добро пожаловать! Данное приложение поможет вам найти интересующую вас вакансию.")
    user_vacancy = input("Введите интересующую вас вакансию: ").lower().strip()
    hh = HeadHunter()
    vacancy_from_hh = hh.get_vacancies(user_vacancy)
    saving_vac = JSONSaver("/home/dia/PycharmProjects/Course_4/data/find_vacs.json")
